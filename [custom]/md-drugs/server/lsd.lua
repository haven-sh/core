...
local lsdLocations = {
    ...
    {
        loc = vector3(-1381.21, -327.75, 39.85),
        l = 1.0,
        w = 1.0,
        rot = 45.0,
        gang = ""
    }, {
        loc = vector3(2405.53, 5008.39, 46.02),
        l = 1.0,
        w = 1.0,
        rot = 45.0,
        gang = ""
    ...
    {
        loc = vector3(-1371.71, -316.02, 39.53),
        l = 1.0,
        w = 1.0,
        rot = 45.0,
        gang = ""
    }, {
        loc = vector3(2408.38, 5011.18, 46.08),
        l = 1.0,
        w = 1.0,
        rot = 45.0,
        gang = ""
    ...
    {
        loc = vector3(-1370.77, -314.51, 39.58),
        l = 1.0,
        w = 1.0,
        rot = 45.0,
        gang = ""
    }, {
        loc = vector3(2409.59, 5012.45, 46.09),
        l = 1.0,
        w = 1.0,
        rot = 45.0,
        gang = ""
    ...
    buyLSDkit = {{
        ...
        loc = vector4(2598.47, 5033.06, 105.86, 283.51),
        l = 1.0,
        w = 1.0,
        rot = 283.51,
        gang = ""
...
RegisterServerEvent('md-drugs:server:getlysergic', function(num)
    local src = source
    if timeOut(src, 'md-drugs:server:getlysergic') then
        return
    end
...
RegisterServerEvent('md-drugs:server:getdiethylamide', function(num)
    local src = source
    if timeOut(src, 'md-drugs:server:getdiethylamide') then
        return
    end
...
RegisterServerEvent('md-drugs:server:heatliquid', function()
    local src = source
    if not hasLabKit(src) then
        return
    end
    if timeOut(src, 'md-drugs:server:heatliquid') then
        return
    end
...
RegisterServerEvent('md-drugs:server:refinequalityacid', function()
    ...
    if not ps.hasItem(src, 'lsd_one_vial', 1) then
        return
    end
...
RegisterServerEvent('md-drugs:server:gettabpaper', function(num)
    local src = source
    if timeOut(src, 'md-drugs:server:gettabpaper') then
        return
    end
...
RegisterServerEvent('md-drugs:server:getlabkit', function(num)
    local src = source
    if timeOut(src, 'md-drugs:server:getlabkit') then
        return
    end
...
RegisterServerEvent('md-drugs:server:maketabpaper', function()
    local src = source
    if timeOut(src, 'md-drugs:server:maketabpaper') then
        return
    end
    if not hasLabKit(src) then
        return
    end
    if not ps.hasItem(src, 'tab_paper', 1) then
        return
    end
    local vialdata = {{
        vial = 'lsd_one_vial',
        sheet = 'smileyfacesheet',
        log = 'Made A Smiley Face Sheet'
    }, {
        vial = 'lsd_vial_two',
        sheet = 'wildcherrysheet',
        log = 'Made A Wild Cherry Sheet'
    }, {
        vial = 'lsd_vial_three',
        sheet = 'yinyangsheet',
        log = 'Made A Yin Yang Sheet'
    }, {
        vial = 'lsd_vial_four',
        sheet = 'pineapplesheet',
        log = 'Made A Pine Apple Sheet'
    }, {
        vial = 'lsd_vial_five',
        sheet = 'bartsheet',
        log = 'Made A Cluckin Bell Sheet'
    }, {
        vial = 'lsd_vial_six',
        sheet = 'gratefuldeadsheet',
        log = 'Made A Maze Sheet'
    }}
...
local sheets = {{
    item = 'smileyfacesheet',
    recieve = "smiley_tabs"
}, {
    item = 'wildcherrysheet',
    recieve = "wildcherry_tabs"
}, {
    item = 'yinyangsheet',
    recieve = "yinyang_tabs"
}, {
    item = 'pineapplesheet',
    recieve = "pineapple_tabs"
}, {
    item = 'bartsheet',
    recieve = "bart_tabs"
}, {
    item = 'gratefuldeadsheet',
    recieve = "gratefuldead_tabs"
}}
