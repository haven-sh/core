...
local xtcLocations = {
    ...
    {
        loc = vector3(844.39, -902.92, 25.42),
        l = 1.0,
        w = 1.0,
        rot = 45.0,
        gang = ""
    ...
    {
        loc = vector3(844.4, -898.79, 25.23),
        l = 1.0,
        w = 1.0,
        rot = 45.0,
        gang = ""
    ...
    {
        loc = vector3(844.71, -910.33, 25.37),
        l = 1.0,
        w = 1.0,
        rot = 45.0,
        gang = ""
    ...
    xtcpress = {{
        ...
        loc = vector4(845.82, -884.79, 25.18, 180.0),
        l = 1.0,
        w = 1.0,
        rot = 45.0,
        gang = ""
    ...
    {
        loc = vector3(844.71, -900.56, 25.43),
        l = 1.0,
        w = 1.0,
        rot = 45.0,
        gang = ""
...
RegisterServerEvent('md-drugs:server:stealisosafrole', function(num)
    ...
    if timeOut(src, 'md-drugs:server:stealisosafrole') then
        return
    end
...
RegisterServerEvent('md-drugs:server:stealmdp2p', function(num)
    ...
    if timeOut(src, 'md-drugs:server:stealmdp2p') then
        return
    end
...
local presses = {{
    item = 'singlepress',
    data = 'singlestack',
    recipes = RecipeList.singlestack
}, {
    item = 'dualpress',
    data = 'dualstack',
    recipes = RecipeList.dualstack
}, {
    item = 'triplepress',
    data = 'triplestack',
    recipes = RecipeList.triplestack
}, {
    item = 'quadpress',
    data = 'quadstack',
    recipes = RecipeList.quadstack
}}
...
RegisterServerEvent('md-drugs:server:getpressback', function()
    ...
    if not ps.checkDistance(src, press.loc, 2.0) then
        return
    end
...
RegisterServerEvent('md-drugs:server:makextc', function(data)
    ...
    if timeOut(src, 'md-drugs:server:makextc') then
        return
    end
    if not ps.checkDistance(src, activePresses[src].loc, 2.0) then
        return
    end
...
RegisterServerEvent('md-drugs:server:buypress', function(loc, item)
    ...
    if timeOut(src, 'md-drugs:server:buypress') then
        return
    end
...
RegisterServerEvent('md-drugs:server:upgradepress', function(data)
    local src = source
    if timeOut(src, 'md-drugs:server:upgradepress') then
        return
    end
...
RegisterServerEvent('md-drugs:server:makingrawxtc', function(num)
    ...
    if timeOut(src, 'md-drugs:server:makingrawxtc') then
        return
    end
...
RegisterServerEvent('md-drugs:server:stamp', function(num, color)
    local src = source
    if not ps.checkDistance(src, xtcLocations.stamp[num].loc, 3.0) then
        return
    end
    if timeOut(src, 'md-drugs:server:stamp') then
        return
    end
